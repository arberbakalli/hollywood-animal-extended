...
Reference and institutional knowledge for `hollywood-animal-extended`.
...
Deleted 2026-09-17:
- `ENGINEERING_SPECS.md` - shipped branch specs for `major-changes`; all features implemented.
- `GAME_VISUAL_ASSETS.md` - UI polish research; shelved pending design decisions.
